        ...
        <Row>
          <Col md={{ span: 10, offset: 1 }}>
            ...
            <ol>
              ...
              <li className="agreement-text">
                This agreement has legal consequences and by entering into this agreement you release all rights, claims, or other causes of action whether in equity or law you may have against OG DAO service providers or other OG DAO participants.
                <br/>
                You also agree to waive and limit any potential liability of OG DAO service providers or other OG DAO participants.
              </li>
              <li className="agreement-text">
        ...
        <Row className="my-4" style={{ border: "1px solid #d3d3d3" }}>
          <Col md={{ span: 4, offset: 1 }} className="text-center">
            <table className="table table-bordered my-4">
              ...
              <tbody>
                {this.props.optInAccounts.map((account, index) => {
                  return (
                    <tr key={index}>
                      <td>{index + 1}</td>
          ...
          <Col md={{ span: 4, offset: 2 }} className="text-center">
            <table className="table table-bordered my-4">
              ...
              <tbody>
                {this.props.optOutAccounts.map((account, index) => {
                  return (
                    <tr key={index}>
                      <td>{index + 1}</td>
                      <td>{this.props.minifyHash(account)}</td>
